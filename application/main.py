...
if __name__ == "__main__":
    print(next_grade_score(95))  # 現在の評価はSです。上位の評価(S+)まであと1点です。
    print(next_grade_score(68))  # 現在の評価はB+です。上位の評価(A)まであと3点です。
    print(next_grade_score(58))  # 現在の評価はC+です。上位の評価(B)まであと4点です。
